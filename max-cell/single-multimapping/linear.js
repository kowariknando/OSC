autowatch = 1;
outlets = 8; // 0-4 = five independently-smoothed lanes of the linear value | 5 = battery | 6 = sleep | 7 = idle timeout

// ============================================================================
// linear.js — multi-mapping CodeCell receiver + normaliser (LINEAR ACC)
// Decodes <device>_lin into 5 independently-smoothed lanes (outlets 0-4) plus
// battery on outlet 5. Each lane's Smooth knob sends "smoothamount <lane> <0..100>".
// Auto-range is shared; smoothing is per-lane. See gyro.js for the pipeline.
// ============================================================================
